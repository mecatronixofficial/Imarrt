const strengths = [
  ...
  { num:'03', stroke:'#F5C800', iconBg:'rgba(245,200,0,.15)', size:'24',
  ...
  { num:'04', stroke:'#111', iconBg:'var(--LG)', size:'24',
    title:'Scalable Production', stat:'Bulk Ready',
    text:'Efficient production planning and logistics ensure every order is delivered on schedule.',
