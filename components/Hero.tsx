  ...
  return (
    <section className="hero">
      <div className="h-left">
        <div className="h-tag">✦ Tirupur, Tamil Nadu — Knitwear Capital of India</div>
        <h1 className="h-title">I-Marrt</h1>
        <p className="h-sub">Premium Readymade Garments</p>
        <p className="h-desc">
          Retailer, exporter &amp; supplier of high-quality knit and woven garments — infants,
          children &amp; adults. Based in Rayapuram, Tirupur.
        </p>
        <div className="h-btns">
          <Link href="#products" className="btn-b">Explore Products</Link>
          <Link href="#contact" className="btn-ob">Get a Quote</Link>
        </div>
      ...
      <div className="h-right">
        <div style={{ position: 'relative' }}>
          <div className="h-card">
            ...
            <p>Your trusted garment export partner from the heart of Tirupur, India&apos;s knitwear capital.</p>
